    ...
    <article className="post post--simple">
      <div className="post-head">
        <div className="post-head__author">
          {profileSlug ? (
            <Link href={`/profile/${profileSlug}`} className="post-head__profile-link">
              {avatar}
            </Link>
          ) : (
            avatar
          ...
          <div className="post-head__identity">
            <div className="post-head__name-row">
              {profileSlug ? (
                <Link href={`/profile/${profileSlug}`} className="post-head__profile-link post-head__profile-link--name">
                  {name}
                </Link>
              ) : (
                name
